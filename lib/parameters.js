...
function generateAsyncIteratorArgConversions(ctx, idl, parent, errPrefix) {
  const requires = new utils.RequiresMap(ctx);
  let str = "const args = [];";
...
function generateOverloadConversions(ctx, typeOfOp, name, parent, errPrefix) {
  const requires = new utils.RequiresMap(ctx);
...
const Parameters = { generateAsyncIteratorArgConversions, generateOverloadConversions };

export { generateAsyncIteratorArgConversions, generateOverloadConversions };
