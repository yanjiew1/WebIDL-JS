...
const { areDistinguishable, sameType } = Types;
...
function getEffectiveOverloads(type, A, N, I) {
  const S = [];
...
function distinguishingArgumentIndex(ctx, S) {
...
const Overloads = { getOperations, getEffectiveOverloads, distinguishingArgumentIndex };

export { getOperations, getEffectiveOverloads, distinguishingArgumentIndex };
