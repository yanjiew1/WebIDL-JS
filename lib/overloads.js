import { areDistinguishable, sameType } from "./types.js";
...
export const getEffectiveOverloads = function (type, A, N, I) {
  const S = [];
...
export const distinguishingArgumentIndex = function (ctx, S) {
